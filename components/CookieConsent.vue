        ...
        >
          ...
          <div class="cookie-content">
            <h2 class="cookie-title">
              🍪 {{ $t('cookie.title', 'Cookie Consent') }}
            </h2>
            <p class="cookie-desc">
              {{ $t('cookie.text', 'This site uses cookies to deliver its services and analyze traffic. By clicking \"Accept\", you agree to our use of cookies.') }}
            </p>
